...
if __name__ == "__main__":
    ...
    savedir = r"/home/flynn/lbm_data/roi_1"
    savedir = r"/home/flynn/lbm_data/roi_2"
    mbo.save_as(test_scan, savedir, ext=".tiff", overwrite=False, fix_phase=True, planes=[6], debug=True)
